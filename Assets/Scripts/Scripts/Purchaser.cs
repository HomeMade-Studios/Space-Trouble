...
namespace CompleteProject {
	...
	public class Purchaser : MonoBehaviour, IStoreListener {
		...
		public static string shield1_productId = "shield_1";
		public static string shield5_productId = "shield_5";
		public static string shield10_productId = "shield_10";
		public static string endlessEnergy_productId = "endless_energy";
		...
		public void InitializePurchasing() {
			...
			builder.AddProduct(endlessEnergy_productId, ProductType.NonConsumable);
